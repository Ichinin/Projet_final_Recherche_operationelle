...
struct TGenetic 
{
	...
	double ProbCr;							//Probabilité de croisement : pourcentage de la population parent qui se croise [0%;100%]
	double ProbMut;							//Probabilité de mutation : pourcentage de la population parent qui va muter
	int Gen;								//Compteur de nombre de génération
